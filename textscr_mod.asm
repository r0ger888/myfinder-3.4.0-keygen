...
ScrollFont		LOGFONT <14,0,0,0,FW_DONTCARE,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,0,'courier new'>
ScrollText	    		db	"PERYFERiAH kLAN brings to u another fine release : MyFinder 3.4.0 - *kEyGeN.OnLy*                                                  "
						db  "kgn code by MaryNello , grafikz by r0ger , muzik by smirk .                                                     "
						db  "Greetz 2 all PRF members such as GRUiA, r0ger, sabYn, Al0hA, yMRAN, s0r3l, "
						db  "ShoGunu, WeeGee, B@TRyNU + many of 'em, and also 2 teams like DiSiRE, "
						db  "FEELiNNERS, RLTS, BGSPA, BTCR, and the rest of them "
						db  "who still keep the reversing scene alive even in 2024 :)                                                "
						db  "P.S.: for all lamers and all the cheaterz who are trying to steal our releases"
						db  " or just sell our releases for STONKZ, fuck off."
						db  " nuff said.",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,0
		mov scr.scroll_y,245
		
		mov scr.scroll_width,343
